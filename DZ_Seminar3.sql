DROP DATABASE IF EXISTS dz_seminar3; -- Удаляем БД, если она существует 
CREATE DATABASE IF NOT EXISTS dz_seminar3;
USE dz_seminar3;
...
(Из поля “amt”
сумма в таблице “Заказы” выбрать наименьшее значение)
*/
